 ...
 ?>
	<!DOCTYPE html>
		<html>
			...
			<body>
    			<button type="button" id="logout" onclick="history.back()"></button>
				<center>
            ...
            ?>
                ...
                <div src="commentbox.php" class="chat-popup" id="myForm">
                    <form method="post" action="addocument.php" class="form-container">
                        ...
                        <?php
                            ...
                            "SELECT * FROM posts WHERE post_id='".$docid."'"
                        ?>
                        ...
                        <div style="width: 100%; height: 50%; background-color: green; border-radius: 10px;">
                                <?php echo "
                                    <iframe src=\"postcomment.php?post_id='".$postid."'\" style='height: 100%; width: 100%;'>
                        ...
                        <center>
                            <textarea style="width: 90%; margin-top: 3%;" placeholder="Type message.." name="msg" required></textarea>
